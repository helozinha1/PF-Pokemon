...
const pokemonList =  ['jigglypuff', 'Happiny', 'Spinda','Slakoth','Komala','Minccino', 'Stufful','Girafarig','Whismur','Miltank','Audino','Lickitung', 'Linoone', 'Meowth', 'Skitty'];
pokemonList.forEach(pokemon => {
    displayPokemon(pokemon, '.normal');
});