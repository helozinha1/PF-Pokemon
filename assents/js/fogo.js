...
const pokemonList = ['charmander', 'arcanine', 'flareon','ponyta','torkoal','litleo', 'darumaka','lampent','chimchar','fennekin','blacephalon','fletchling', 'Reshiram', 'Ninetales', 'Salandit'
];
